...
export const subcultureData = {
  profile: {
    salamKhas: "Preserving Cultural Heritage",
    displayName: "UB Corpora",
    title: "Discover the Living Tapestry of UB Corpora",
...
export const projectSteps = [
  ...
  },
  {
    ...
    description: "Cultural expressions were collected through extensive and systematic literature reviews:",
    details: [
  ...
  },
  {
    ...
    description: "Collected data are divided into types or domains based on unique characteristics:",
    details: [
  ...
  },
  {
    ...
    description: "Designed a comprehensive digital platform featuring:",
    details: [
...
export const projectRoadmap = [
  ...
  {
    year: "2027",
    phase: "Phase 3: Institutionalization",
    items: [
