...
export default function RegionDetailPage() {
  ...
  const models3D: Model3D[] = useMemo(() => {
    if (
      subcultureData?.model3dArray &&
      subcultureData.model3dArray.length > 0
    ) {
              ...
              {isLightboxOpen && (
                ...
                >
                  ...
                  <button
                    ...
                    className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/10 hover:bg-white/20 text-white rounded-full p-3 transition-all hover:scale-110 z-10 backdrop-blur-sm"
                    aria-label="Previous image"
                  >
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/10 hover:bg-white/20 text-white rounded-full p-3 transition-all hover:scale-110 z-10 backdrop-blur-sm"
                    aria-label="Next image"
                  >
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent p-6 rounded-b-lg">
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <div className="flex-shrink-0 bg-white/10 backdrop-blur-sm px-3 py-1 rounded-full">
