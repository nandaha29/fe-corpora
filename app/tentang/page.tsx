    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-background">
      ...
      <main className="container mx-auto px-4 py-6 space-y-8 scroll-smooth">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="text-center p-6 bg-gradient-to-br from-orange-100 to-orange-200 rounded-lg border border-orange-200/50 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-default">
                ...
                <div className="text-xl text-orange-600/80">Lexicons</div>
              </div>
        ...
        <section id="about" className="bg-card/60 rounded-xl shadow-sm border border-border p-6 scroll-mt-24">
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              >
                <Card className="group overflow-hidden hover:shadow-lg transition-all duration-300 border-border bg-card/60 backdrop-blur-sm">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {loading ? (
              Array.from({ length: 6 }).map((_, i) => (
                <Card key={i} className="group overflow-hidden animate-pulse border-border bg-card/60 backdrop-blur-sm">
              ...
              landingData?.teamScientis.map((member, index) => (
                <Card key={index} className="group overflow-hidden hover:shadow-lg transition-all duration-300 border-border bg-card/60 h-full">
        ...
        <section id="video" className="bg-card/60 rounded-xl shadow-sm border border-border p-6 scroll-mt-24">
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="group overflow-hidden hover:shadow-lg transition-all duration-300 border-border bg-card/60 overflow-hidden">
